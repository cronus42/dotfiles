...
defbindings("WScreen", {
    ...
    submap(META.."grave", {
        ...
        kpress("grave", "mod_menu.grabmenu(_, _sub, 'focuslist')"),
...
defbindings("WMPlex.toplevel", {
    ...
    kpress(META.."Return", "ioncore.exec_on(_, 'terminator')"),
...
defbindings("WMoveresMode", {
    ...
    kpress("AnyModifier+F11","WMoveresMode.finish(_)"),
